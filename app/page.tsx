...
import { Cog, Truck, Phone, Info, ArrowRight } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-semibold mb-2">Avanceret udstyr</h3>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-600">
                  ...
                  maskinen. Det er med til at sikre arbejdsmiljøet i og omkring
                  maskinen.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-4">
                Sneglen kan desuden bruges i forbindelse med BSM fræsning, både
                til at afhøvle og snegle overskydende jord væk fra vejkanten, og
                den kan også snegle med så stor rotationshastighed, at
                materialet fordeles ud over rabatten.
              </p>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 mb-6">
                Vejservices primære forretningsområde er vejservice og udendørs
                drift og vedligeholdelse. Vejservice har mange års erfaring med
                alle typer af drift og vedligehold.
              </p>
