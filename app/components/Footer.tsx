            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-center">
                  ...
                  <span className="text-gray-300">Telefon: +45 XX XX XX XX</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-4 h-4 mr-2 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300 whitespace-pre-line">Adresse: Industrivej XX<br />XXXX By<br />Danmark</span>
                </li>
              </ul>
            </div>
