        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border">
              ...
              <h2 className="text-2xl font-bold mb-4 text-center">Vejservice</h2>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border">
              ...
              <h2 className="text-2xl font-bold mb-4 text-center">Traditionelle anlægsopgaver</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border">
              ...
              <h2 className="text-2xl font-bold mb-4 text-center">Store infrastrukturopgaver</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border">
              ...
              <h2 className="text-2xl font-bold mb-4 text-center">Asfalt</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
