...
import { 
  ...
  type ValidatedContactPage 
} from '@/utils/contentValidation';
import { ErrorBoundary } from '@/app/components/ErrorBoundary';

async function getContactPageData(): Promise<ValidatedContactPage> {
  const { data: contactPage, error } = await safeSanityFetch(
    contactPageQuery,
    validateContactPage,
    defaultContactPageData
  );
  ...
  if (error && contactPage) {
    console.warn('Contact page loaded with fallback data due to error:', error.message);
  }

  // Return the validated data or fallback
  return contactPage || defaultContactPageData;
}
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                      ...
                      <>
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            {data.contactInfo.emailResponse && (
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            {data.contactInfo.emergencyHours && (
                ...
                {data.serviceAreas && (
                  <div>
                    ...
                    {data.serviceAreas.areas && data.serviceAreas.areas.length > 0 && (
              ...
              <div>
                <div className="bg-gray-50 p-8 rounded-lg">
                  <h2 className="text-2xl font-bold text-gray-800 mb-6">
                    {data.contactForm?.title || 'Send os en besked'}
                  </h2>
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      >
                        {data.contactForm?.serviceOptions && data.contactForm.serviceOptions.length > 0 ? (
                    ...
                    >
                      {data.contactForm?.submitButtonText || 'Send besked'}
                    </button>
